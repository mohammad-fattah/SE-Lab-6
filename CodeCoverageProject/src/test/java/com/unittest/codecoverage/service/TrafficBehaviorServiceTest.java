...
public class TrafficBehaviorServiceTest {
	...
	@Test
	@DisplayName("Should throw exception when footpassenger crosses the crosswalk during heavy traffic without looking two sides")
	public void testFootpassengerCrossTheCrossWalkInTheTwoWayStreet_shouldThrowBehaviorExceptionWhenFootpassengerCrossesTheRoadDuringHeavyTrafficWithoutLookTwoSides() {
